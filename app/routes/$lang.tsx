    ...
    <div className="h-full w-full relative">
      <div>
        ...
        <div className="absolute inset-0 w-full h-full z-10 flex flex-col overflow-hidden">
          ...
          <>
            <div className={((location.pathname.includes('works') || location.pathname.includes('about') || location.pathname.includes('contacts')) ? outletHeight : "h-0 ") + "relative z-30 w-full bg-white transition-all ease-in-out duration-500 max-w-[60vh] lg:max-h-[70vh] "}>
              <Outlet />
            </div>
          </>
        </div>
