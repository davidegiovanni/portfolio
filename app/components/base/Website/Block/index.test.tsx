...
describe("Block", async () => {
  it("should render default block data", async () => {
    ...
    const RemixStub = createRemixStub([
      {
        path: "/",
        Component: () => <PageBlock {...blockProps} />,
      },
    ]);
  ...
  it("should render default block items", async () => {
    const blockProps: BlockProps = {
      index: 0,
      block: {
        title: "Block title",
  ...
  it("should render default custom html", async () => {
    const blockProps: BlockProps = {
      index: 0,
      block: {
        title: "",
    ...
    const RemixStub = createRemixStub([
      {
        path: "/",
        Component: () => <div><PageBlock {...blockProps} /></div>,
      },
    ]);
    render(<RemixStub initialEntries={["/"]} />);
  ...
  it("should render main block data", async () => {
    const blockProps: BlockProps = {
      index: 0,
      block: {
        title: "Block title",
  ...
  it("should render main block items", async () => {
    const blockProps: BlockProps = {
      index: 0,
      block: {
        title: "Block title",
  ...
  it("should render main custom html", async () => {
    const blockProps: BlockProps = {
      index: 0,
      block: {
        title: "",
