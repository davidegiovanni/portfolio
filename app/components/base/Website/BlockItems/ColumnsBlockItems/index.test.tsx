...
import type { ColumnsBlockItemsProps } from ".";
import ColumnsBlockItems from ".";

describe("Default block block items", async () => {
  it("should render grid block items", async () => {
    const blockItemProps: ColumnsBlockItemsProps = {
      index: 0,
      block: {
        title: "Block title",
    ...
    const RemixStub = createRemixStub([
      {
        path: "/",
        Component: () => <ColumnsBlockItems {...blockItemProps} />,
      },
    ]);
