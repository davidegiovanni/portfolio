...
const canvasRef = useRef<HTMLCanvasElement | null>(null);
  ...
  return (
    <div data-showing={props.isShowingCanvas} className='fixed z-30 opacity-0 pointer-events-none data-[showing=true]:opacity-100 inset-0 data-[showing=true]:pointer-events-auto'>
      ...
      />
      <div data-showing={props.isShowingCanvas} className='absolute transition-all -translate-y-12 data-[showing=true]:delay-200 data-[showing=true]:duration-300 data-[showing=true]:ease-in-out data-[showing=true]:translate-y-0 left-0 top-0 z-20 inline-flex items-center gap-4 p-4 bg-white'>
